  ...
  switch (req.method) {
    case 'initialize':
      return jsonRpcResult(req.id, {
        ...
        instructions:
          'MCP server for managing blog articles on isaacsuttell.com. You can create, edit, publish, unpublish, archive, and restore blog posts. Supports version history and soft-delete recovery.',
      });
