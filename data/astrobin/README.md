...
- The local Orion and Virgo Cluster images now have separate Astrometry.net solutions, bringing the gallery to eleven solved images. Their WCS, catalog matches, validation, and reproduction steps are in [the Orion solution](../astrometry/orion-nebula/README.md) and [the Virgo solution](../astrometry/virgo-cluster/README.md). Starless Orion remains without an overlay.
